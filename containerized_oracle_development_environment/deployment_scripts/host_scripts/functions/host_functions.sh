...
#	echo "running proj_host_deploy_container()"
	...
	local -A func_args=(
			...
			["env_block"]="$(cds_shared_generate_export_env_vars_block "DB_IMAGE" "DB_HOST_PORT" "DBPORT" "ORACLE_PWD" "DBHOST" "DBSERVICENAME" "TARGET_APEX_VERSION" "APP_SCHEMA_NAME" "ORDS_IMAGE" "COMPOSE_FILE" "COMPOSE_PROJECT_NAME" "ORDS_HOST_PORT" "ENV_NAME")"
